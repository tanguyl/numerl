-module(numerl).
-on_load(init/0).
-export([ eval/1, eye/1, zeros/2, equals/2, add/2, sub/2,mult/2, divide/2, matrix/1, rnd_matrix/1, get/3, at/2, mtfli/1, row/2, col/2, transpose/1, inv/1, print/1, dnrm2/1, ddot/2, daxpy/4, dgemv/5, dot/2]).
